...
function decodeDDCB(z80: Z80): void {
    ...
    switch (inst) {
        ...
        case 0x00: { // ld b,rlc
            // We don't yet implement undocumented opcodes: rlc b
        ...
        case 0x01: { // ld c,rlc
            // We don't yet implement undocumented opcodes: rlc c
        ...
        case 0x02: { // ld d,rlc
            // We don't yet implement undocumented opcodes: rlc d
        ...
        case 0x03: { // ld e,rlc
            // We don't yet implement undocumented opcodes: rlc e
        ...
        case 0x04: { // ld h,rlc
            // We don't yet implement undocumented opcodes: rlc h
        ...
        case 0x05: { // ld l,rlc
            // We don't yet implement undocumented opcodes: rlc l
        ...
        case 0x07: { // ld a,rlc
            // We don't yet implement undocumented opcodes: rlc a
        ...
        case 0x08: { // ld b,rrc
            // We don't yet implement undocumented opcodes: rrc b
            z80.regs.b = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x09: { // ld c,rrc
            // We don't yet implement undocumented opcodes: rrc c
            z80.regs.c = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x0A: { // ld d,rrc
            // We don't yet implement undocumented opcodes: rrc d
            z80.regs.d = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x0B: { // ld e,rrc
            // We don't yet implement undocumented opcodes: rrc e
            z80.regs.e = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x0C: { // ld h,rrc
            // We don't yet implement undocumented opcodes: rrc h
            z80.regs.h = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x0D: { // ld l,rrc
            // We don't yet implement undocumented opcodes: rrc l
            z80.regs.l = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x0F: { // ld a,rrc
            // We don't yet implement undocumented opcodes: rrc a
            z80.regs.a = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x10: { // ld b,rl
            // We don't yet implement undocumented opcodes: rl b
            z80.regs.b = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x11: { // ld c,rl
            // We don't yet implement undocumented opcodes: rl c
            z80.regs.c = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x12: { // ld d,rl
            // We don't yet implement undocumented opcodes: rl d
            z80.regs.d = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x13: { // ld e,rl
            // We don't yet implement undocumented opcodes: rl e
            z80.regs.e = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x14: { // ld h,rl
            // We don't yet implement undocumented opcodes: rl h
            z80.regs.h = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x15: { // ld l,rl
            // We don't yet implement undocumented opcodes: rl l
            z80.regs.l = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x17: { // ld a,rl
            // We don't yet implement undocumented opcodes: rl a
            z80.regs.a = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x18: { // ld b,rr
            // We don't yet implement undocumented opcodes: rr b
            z80.regs.b = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x19: { // ld c,rr
            // We don't yet implement undocumented opcodes: rr c
            z80.regs.c = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x1A: { // ld d,rr
            // We don't yet implement undocumented opcodes: rr d
            z80.regs.d = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x1B: { // ld e,rr
            // We don't yet implement undocumented opcodes: rr e
            z80.regs.e = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x1C: { // ld h,rr
            // We don't yet implement undocumented opcodes: rr h
            z80.regs.h = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x1D: { // ld l,rr
            // We don't yet implement undocumented opcodes: rr l
            z80.regs.l = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x1F: { // ld a,rr
            // We don't yet implement undocumented opcodes: rr a
            z80.regs.a = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x20: { // ld b,sla
            // We don't yet implement undocumented opcodes: sla b
            z80.regs.b = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x21: { // ld c,sla
            // We don't yet implement undocumented opcodes: sla c
            z80.regs.c = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x22: { // ld d,sla
            // We don't yet implement undocumented opcodes: sla d
            z80.regs.d = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x23: { // ld e,sla
            // We don't yet implement undocumented opcodes: sla e
            z80.regs.e = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x24: { // ld h,sla
            // We don't yet implement undocumented opcodes: sla h
            z80.regs.h = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x25: { // ld l,sla
            // We don't yet implement undocumented opcodes: sla l
            z80.regs.l = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x27: { // ld a,sla
            // We don't yet implement undocumented opcodes: sla a
            z80.regs.a = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x28: { // ld b,sra
            // We don't yet implement undocumented opcodes: sra b
            z80.regs.b = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x29: { // ld c,sra
            // We don't yet implement undocumented opcodes: sra c
            z80.regs.c = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x2A: { // ld d,sra
            // We don't yet implement undocumented opcodes: sra d
            z80.regs.d = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x2B: { // ld e,sra
            // We don't yet implement undocumented opcodes: sra e
            z80.regs.e = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x2C: { // ld h,sra
            // We don't yet implement undocumented opcodes: sra h
            z80.regs.h = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x2D: { // ld l,sra
            // We don't yet implement undocumented opcodes: sra l
            z80.regs.l = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x2F: { // ld a,sra
            // We don't yet implement undocumented opcodes: sra a
            z80.regs.a = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x30: { // ld b,sll
            // We don't yet implement undocumented opcodes: sll b
            z80.regs.b = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x31: { // ld c,sll
            // We don't yet implement undocumented opcodes: sll c
            z80.regs.c = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x32: { // ld d,sll
            // We don't yet implement undocumented opcodes: sll d
            z80.regs.d = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x33: { // ld e,sll
            // We don't yet implement undocumented opcodes: sll e
            z80.regs.e = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x34: { // ld h,sll
            // We don't yet implement undocumented opcodes: sll h
            z80.regs.h = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x35: { // ld l,sll
            // We don't yet implement undocumented opcodes: sll l
            z80.regs.l = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x37: { // ld a,sll
            // We don't yet implement undocumented opcodes: sll a
            z80.regs.a = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x38: { // ld b,srl
            // We don't yet implement undocumented opcodes: srl b
            z80.regs.b = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x39: { // ld c,srl
            // We don't yet implement undocumented opcodes: srl c
            z80.regs.c = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x3A: { // ld d,srl
            // We don't yet implement undocumented opcodes: srl d
            z80.regs.d = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x3B: { // ld e,srl
            // We don't yet implement undocumented opcodes: srl e
            z80.regs.e = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x3C: { // ld h,srl
            // We don't yet implement undocumented opcodes: srl h
            z80.regs.h = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x3D: { // ld l,srl
            // We don't yet implement undocumented opcodes: srl l
            z80.regs.l = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x3F: { // ld a,srl
            // We don't yet implement undocumented opcodes: srl a
            z80.regs.a = z80.readByte(z80.regs.memptr);
            z80.incTStateCount(1);
            {
                let value: number;
        ...
        case 0x80: { // ld b,res
            // We don't yet implement undocumented opcodes: res b
        ...
        case 0x81: { // ld c,res
            // We don't yet implement undocumented opcodes: res c
        ...
        case 0x82: { // ld d,res
            // We don't yet implement undocumented opcodes: res d
        ...
        case 0x83: { // ld e,res
            // We don't yet implement undocumented opcodes: res e
        ...
        case 0x84: { // ld h,res
            // We don't yet implement undocumented opcodes: res h
        ...
        case 0x85: { // ld l,res
            // We don't yet implement undocumented opcodes: res l
        ...
        case 0x87: { // ld a,res
            // We don't yet implement undocumented opcodes: res a
        ...
        case 0xC0: { // ld b,set
            // We don't yet implement undocumented opcodes: set b
        ...
        case 0xC1: { // ld c,set
            // We don't yet implement undocumented opcodes: set c
        ...
        case 0xC2: { // ld d,set
            // We don't yet implement undocumented opcodes: set d
        ...
        case 0xC3: { // ld e,set
            // We don't yet implement undocumented opcodes: set e
        ...
        case 0xC4: { // ld h,set
            // We don't yet implement undocumented opcodes: set h
        ...
        case 0xC5: { // ld l,set
            // We don't yet implement undocumented opcodes: set l
        ...
        case 0xC7: { // ld a,set
            // We don't yet implement undocumented opcodes: set a
