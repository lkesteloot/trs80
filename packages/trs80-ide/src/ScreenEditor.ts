...
import invertIcon from "./icons/invert.js";
import drawIcon from "./icons/draw.js";
import eraseIcon from "./icons/erase.js";
import pixelGridIcon from "./icons/pixel_grid.js";
import charGridIcon from "./icons/char_grid.js";
import highlightGridIcon from "./icons/highlight_grid.js";
...
import bucketIcon from "./icons/bucket.js";
...
import flipHorizontalIcon from "./icons/flip_horizontal.js";
import flipVerticalIcon from "./icons/flip_vertical.js";
        ...
        if (s.firstDataLineNumber !== undefined && s.lastDataLineNumber !== undefined) {
            ...
            for (let lineNumber = s.firstDataLineNumber; lineNumber <= s.lastDataLineNumber; lineNumber++) {
                ...
                if (length < binary.length) {
                    this.extraBytes = binary.slice(length);
                    break;
                }
            }
