...
import {Mutable} from "trs80-emulator";
...
// https://thenounproject.com/icon/trash-6418196/
const TRASH_ICON = `
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="7 7 50 66">
    <g fill="white">
        <path d="M53,15.5H11.1c-1,0-1.9,0.7-2.1,1.7c-0.2,1.3,0.8,2.3,2,2.3h4.4l3.2,37.7c0,0.4,0.4,0.8,0.8,0.8h25.1
            c0.4,0,0.8-0.3,0.8-0.8l3.2-37.7h4.2c1,0,1.9-0.7,2.1-1.7C55.2,16.6,54.2,15.5,53,15.5z M26.7,51h-0.2c-1,0-1.9-0.8-2-1.8l-2-24.5
            c-0.1-1.1,0.7-2.1,1.8-2.2c1.1-0.1,2.1,0.7,2.1,1.8l2,24.5C28.6,49.9,27.8,50.9,26.7,51z M39.5,49.2c-0.1,1-1,1.8-2,1.8h-0.2
            c-1.1-0.1-1.9-1.1-1.8-2.2l2-24.5c0.1-1.1,1.1-1.9,2.1-1.8c1.1,0.1,1.9,1.1,1.8,2.2L39.5,49.2z"/>
        <path d="M41.5,6.6c0-0.3-0.3-0.6-0.6-0.6H23.1c-0.3,0-0.6,0.3-0.6,0.6v4.9h19V6.6z"/>
    </g>
</svg>
`;
...
export class ControlPanel {
     ...
     */
    private addButton(iconSvg: string, hoverText: string, callback?: () => void): HTMLElement {
    ...
    public addResetButton(callback: () => void): HTMLElement {
        return this.addButton(RESET_ICON, "Reboot the computer", callback);
    }
    ...
    public addScreenshotButton(callback: () => void): HTMLElement {
        return this.addButton(CAMERA_ICON, "Take a screenshot", callback);
    }
    ...
    public addTapeRewindButton(callback: () => void): HTMLElement {
        return this.addButton(PREVIOUS_TRACK_ICON, "Rewind the cassette", callback);
    }
    ...
    public addSettingsButton(settingsPanel: SettingsPanel): HTMLElement {
        ...
        return this.addButton(iconSvg, "Show the settings panel", () => settingsPanel.open());
    }
    ...
    public addEditorButton(callback: () => void): HTMLElement {
        return this.addButton(EDIT_ICON, "Edit the program (Ctrl-Enter)", callback);
    }
    ...
    public addPrinterButton(callback: () => void): HTMLElement {
        return this.addButton(PRINTER_ICON, "Show printer", callback);
    }
    ...
    public addCloseButton(callback: () => void): void {
        this.addButton(CHECK_ICON, "Close", callback);
    }
    ...
    /**
     * Add a button with a trash symbol.
     */
    public addTrashButton(callback: () => void): void {
        this.addButton(TRASH_ICON, "Clear printout", callback);
    }
