(function (global, factory) {
            ...
            while (frame < samples.length) {
                ...
                switch (state) {
                    ...
                    case TapeDecoderState.FINISHED:
                        ...
                        const program = new Program(trackNumber, copyNumber, programStartFrame, frame, tapeDecoders[0].getName(), tapeDecoders[0].getProgram(), tapeDecoders[0].getBits());
    ...
    function handleAudioBuffer(pathname, audioBuffer) {
        ...
        decoder.decode();
        const tapeBrowser = new TapeBrowser(tape, zoomInButton, zoomOutButton, waveforms, originalCanvas, filteredCanvas, lowSpeedCanvas, programText, tapeContents);
        tapeBrowser.draw();
        // Switch screens.
